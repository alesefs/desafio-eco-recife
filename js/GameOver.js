Campus.GameOver = function(game) {
	gOver = null;
	b_jogar = null;
	b_menu = null;
};
Campus.GameOver.prototype = {
	create: function() {
		...
		//titulo
		gOver = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 125, 'Gover');
		gOver.anchor.setTo(0.5,0.5);
